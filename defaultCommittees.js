/**
 * This file holds the *full* default data for the committees
 * (both Senate and House) plus the femaleNames array.
 * We expose them as global variables for script.js to pick up.
 */

// Full array of known female names:
window.FEMALE_NAMES = [
  "Diane Larson",
  "Kathy Hogan",
  "Judy Lee",
...
// Full default committees data (Senate + House):
window.DEFAULT_COMMITTEES = {
  // ---------- SENATE -----------
